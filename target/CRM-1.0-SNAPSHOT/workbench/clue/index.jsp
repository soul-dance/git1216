			...
			$.ajax({
				...
				success:function (data) {
					if(data.success){
						...
						//清空添加操作模态窗口中的数据 [0]是为了转为js对象才可以使用
						$("#clueAddForm")[0].reset();
						//关闭添加操作的模态窗口
		...
		<div class="modal-dialog" role="document" style="width: 90%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" id="addBtn" class="btn btn-primary" data-dismiss="modal">保存</button>
				</div>
			</div>
		</div>
	</div>
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 40px;">
				<div class="btn-group" style="position: relative; top: 18%;">
				  <button type="button" class="btn btn-primary " id="creatBtn" ><span class="glyphicon glyphicon-plus"></span> 创建</button>
			...
			<div style="position: relative;top: 50px;">
				<table class="table table-hover">
					...
					<tbody id="clueBody">
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/clue/detail.do?id=';">马云先生</a></td>
							<td>动力节点</td>
							<td>010-84846003</td>
							<td>12345678901</td>
							<td>广告</td>
			...
			<div style="height: 40px; position: relative;top: 60px;">
